...
impl ::std::default::Default for TermKeyKey {
    fn default() -> TermKeyKey {
        TermKeyKey {
            type_: TermKeyType::TERMKEY_TYPE_UNICODE,
            code: 0,
            modifiers: 0,
            utf8: [0; 7],
        }
...
impl TermKeyKey {
    pub fn from_codepoint(
        mods: X_TermKey_KeyMod,
        codepoint: char,
        utf8: [c_char; 7],
    ) -> TermKeyKey {
        unsafe {
    ...
    pub fn from_num(mods: X_TermKey_KeyMod, num: isize) -> TermKeyKey {
        unsafe {
            ...
            let mut key = TermKeyKey {
                type_: TermKeyType::TERMKEY_TYPE_FUNCTION,
                code: 0,
                modifiers: mods,
                utf8: [0; 7],
            };
    ...
    pub fn from_sym(mods: X_TermKey_KeyMod, sym: TermKeySym) -> TermKeyKey {
        unsafe {
            let mods: c_int = ::std::mem::transmute(mods);
            let mut key = TermKeyKey {
                type_: TermKeyType::TERMKEY_TYPE_KEYSYM,
                code: 0,
                modifiers: mods,
                utf8: [0; 7],
            };
    ...
    pub fn from_mouse(
        ...
        unsafe {
            let mods: c_int = ::std::mem::transmute(mods);
            let mut key = TermKeyKey {
                type_: TermKeyType::TERMKEY_TYPE_MOUSE,
                code: 0,
                modifiers: mods,
                utf8: [0; 7],
            };
    ...
    pub fn from_position(line: c_int, col: c_int) -> TermKeyKey {
        unsafe {
            let mut key = TermKeyKey {
                type_: TermKeyType::TERMKEY_TYPE_POSITION,
                code: 0,
                modifiers: 0,
                utf8: [0; 7],
            };
    ...
    pub fn from_mode_report(initial: c_int, mode: c_int, value: c_int) -> TermKeyKey {
        unsafe {
            let mut key = TermKeyKey {
                type_: TermKeyType::TERMKEY_TYPE_MODEREPORT,
                code: 0,
                modifiers: 0,
                utf8: [0; 7],
            };
...
extern "C" {
    ...
    pub fn termkey_register_keyname(
        tk: *mut TermKey,
        sym: TermKeySym,
        name: *const c_char,
    ) -> TermKeySym;
    ...
    pub fn termkey_keycmp(
        tk: *mut TermKey,
        key1: *const TermKeyKey,
        key2: *const TermKeyKey,
    ) -> c_int;
}
